...
public class RecipesCuisineTest extends AbstractTest {
	  ...
	  void How_make_MannicottiTest() {
			Response response = given().spec(getRequestSpecification())
				...
				.get("https://spoonacular.com/recipes.cuisine?query=How to make Mannicotti")
				.prettyPeek()
				.then()
				.extract()
				.response()
	  ...
	  void How_to_Make_Braised_BeefTest() {
			Response response = given().spec(getRequestSpecification())
				...
				.get("https://spoonacular.com/recipes.cuisine?quary=How to Make Braised Beef")
				.prettyPeek()
				.then()
				.extract()
				.response()
	  ...
	  void Cream_CornTest() {
			Response response = given().spec(getRequestSpecification())
				...
				.get("https://spoonacular.com/recipes.cuisine?quary=Cream Corn Like No Other")
				.prettyPeek()
				.then()
				.extract()
				.response()
	  ...
	  void How_to_Make_Bannana_CakeTest() {
			Response response = given().spec(getRequestSpecification())
				...
				.get("https://spoonacular.com/recipes.cuisine?quary=How to Make Bannana Cake")
				.prettyPeek()
				.then()
